...
DenseMatrix::DenseMatrix(std::size_t rows, std::size_t columns, const double &value) : Matrix(rows, columns),
                                                                                       m_data(n_rows * n_cols, value)
{
}

DenseMatrix::DenseMatrix(std::size_t rows, std::size_t columns, std::vector<double> values) : Matrix(rows, columns),
                                                                                              m_data(values)
{
}
